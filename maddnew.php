 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">  <a class="nav-link" href="maddnew.php">Create Customer</a></li>
      <li class="nav-item ">  <a class="nav-link" href="mfeedback.php">Tickets</a></li>
...
<div class="card w-100 text-center shadowBlack">
  ...
  <div class="card-body bg-bright text-black">
    <table class="table">
      <tbody>
        <tr>
          <form method="POST">
