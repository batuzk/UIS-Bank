          ...
          { $row2 = $array2->fetch_assoc();?>
            <div class='row'>
                  ...
                  <!-- Req. 3.1.1 Cashier should provide a transaction number, and amount number for making deposit or withdrawal transaction for a customer’s needs. -->
                   ...
                   <button type='submit' name='withdrawOther' value="withdrawOther" class='btn btn-success btn-bloc btn-sm my-1'> Withdraw</button></form>
                  </div>
                </div>
            <?php
           ...
           ?>
            <div class='row'>
                  <div class='col'>
                    ...
                    Account Holder Bank Name.
                    <input type='text' class='form-control' value='<?php echo bankName; ?>' readonly required>Bank Balance
                    <input type='text' class='form-control my-1'  value='<?=$row2['balance']?>' readonly required>
                  ...
                  <div class='col'>
                   ...
                   <button type='submit' name='deposit'  value='deposit' class='btn btn-success btn-bloc btn-sm my-1'> Deposit</button></form>
                  </div>
                </div>
