<form class="form-inline my-2 my-lg-0">
        <a href="" class="btn btn-outline-success" data-toggle="tooltip" title="Your current account b.alance">Acount Balance: $<?php echo $userData['balance']; ?></a>  
        <a href="accounts.php" data-toggle="tooltip" title="Account Information" class="btn btn-outline-primary mx-1" ><i class="fa fa-book fa-fw"></i></a> 
